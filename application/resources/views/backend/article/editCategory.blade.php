...
@section('title')
	Article Category Management - Edit
@endsection
...
@section('content')
	...
	<h1>Article Category Management - Edit</h1>

	<form class="form-horizontal form-label-left" action="{{ route('admin.article.updateCategory', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				...
				@if($index->logo != '')
					<img src="{{ asset($index->logo) }}" style="height: 100px;"/>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="file" id="meta_image" name="meta_image" class="form-control {{$errors->first('name') != '' ? 'parsley-error' : ''}}">
				@if($index->meta_image != '')
