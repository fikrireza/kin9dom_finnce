...
@section('content')
	...
	<h1>Event Management - Create</h1>

	<form class="form-horizontal form-label-left" action="{{ route('admin.event.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="date" name="date" class="form-control {{$errors->first('date') != '' ? 'parsley-error' : ''}}" value="{{ old('date') != '' ? date('d F Y', strtotime(old('date'))) : '' }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="time" name="time" class="form-control {{$errors->first('time') != '' ? 'parsley-error' : ''}}" value="{{ old('time') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="location" name="location" class="form-control {{$errors->first('location') != '' ? 'parsley-error' : ''}}" value="{{ old('location') }}">
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="file" id="meta_image" name="meta_image" class="form-control {{$errors->first('name') != '' ? 'parsley-error' : ''}}" value="{{ old('meta_image') }}">
				<ul class="parsley-errors-list filled">
					<li class="parsley-required">{{ $errors->first('name') }}</li>
				</ul>
			</div>
