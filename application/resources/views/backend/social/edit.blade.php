...
@section('content')
	...
	<h1>Social Management - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.social.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
