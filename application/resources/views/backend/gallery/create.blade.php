...
@section('content')
	...
	<h1>Gallery Management - Create</h1>

	<form class="form-horizontal form-label-left" action="{{ route('admin.gallery.store') }}" method="post" enctype="multipart/form-data">
