...
@section('content')
	...
	<form method="post" id="action" action="{{ route('admin.gallery.action') }}" class="form-inline text-right">
		<a href="{{ route('admin.gallery.create') }}" class="btn btn-default">Create New</a>
	...
	<table class="table table-striped table-bordered" id="datatable-buttons">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="{{ route('admin.gallery.edit', ['id' => $list->id]) }}"><i class="fa fa-pencil"></i></a>
					<a href="{{ route('admin.gallery.delete', ['id' => $list->id]) }}" style="color: red;"><i class="fa fa-times"></i></a>
				</td>
			</tr>
			@endforeach
		</tbody>
