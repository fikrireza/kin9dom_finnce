...
@section('content')
	...
	<h1>Gallery Management - Edit</h1>

	<form class="form-horizontal form-label-left" action="{{ route('admin.gallery.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<textarea class="form-control {{$errors->first('name') != '' ? 'parsley-error' : ''}} {{$errors->first('description') != '' ? 'parsley-error' : ''}}" name="description" id="description">{{ old('description') == '' ? $index->description : old('description') }}</textarea>
				<ul class="parsley-errors-list filled">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<input type="text" id="meta_url" name="meta_url" class="form-control {{$errors->first('name') != '' ? 'parsley-error' : ''}}" value="{{ old('meta_url') == '' ? $index->meta_url : old('meta_url') }}">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
				{{ csrf_field() }}
				<a class="btn btn-primary" href="{{ route('admin.gallery') }}">Cancel</a>
